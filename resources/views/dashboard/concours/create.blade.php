            ...
            <div class="card-body mx-auto col-md-10 ">
                <form method="POST" action="{{ route('dashboard.book.store') }}"enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group control-group increment d-flex justify-content-center align-items-center" >
                            ...
                            <label class="custom-file-label cursor-pointer form-control form-control-solid h-auto p-5 border-0  font-size-h6" for="chooseFile">@lang('site.select') @lang('site.book')</label>
                            <div class="input-group-btn">
                              <button class="btn btn-success cursor-pointer form-control  h-auto p-5 border-0  font-size-h6" type="button"><i class="glyphicon glyphicon-plus"></i>Add</button>
                            </div>
                          </div>
                             @error('book')
                        <span class="invalid-feedback" role="alert">
