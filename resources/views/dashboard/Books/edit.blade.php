            ...
            <div class="card-body mx-auto col-md-10 ">
                <form method="POST" action="{{ route('dashboard.book.update',$book->id) }}"enctype="multipart/form-data">
                    ...
                    <div class="form-group  ">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror form-control-solid h-auto p-5 border-0 rounded-lg font-size-h6"  placeholder="@lang('site.title')" value="{{ $book->title }}">
                        @error('title')
                    ...
                    <div class="form-group  ">
                        ...
                        <textarea name="description"class="form-control @error('description') is-invalid @enderror form-control-solid h-auto p-5 border-0 rounded-lg font-size-h6"  placeholder="@lang('site.description')" value="" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 96px;resize:none">{{ $book->description }}</textarea>
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group  ">
                        ...
                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                            <div class="image-input-wrapper" style="background-image: url({{$book->path_image}})"></div>
                    ...
                    <div class="form-group">
                        <label class="font-size-h6 font-weight-bolder text-dark d-block">@lang('site.subject')</label>
							<select class="form-control border-0 form-control-solid text-muted font-size-lg font-weight-bolder pl-5 min-h-50px @error('subject_id') form-is-invalid @enderror" name="subject_id" id="exampleSelects">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="book" class="custom-file-input cursor-pointer @error('book') is-invalid @enderror form-control-solid h-auto p-5 border-0 rounded-lg font-size-h6" id="chooseFile"value="{{$book->book}}">
