<!-- Deleted inFormation book -->
<div class="modal fade text-left" id="Delete_Book{{$book->id}}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered modal-dialog" role="document">
          <div class="modal-content">
             <div class="modal-header bg-danger">
                      <h5 class="modal-title text-light" id="myModalLabel120">
                          <i class="far fa-trash-alt text-light mr-2"></i>
                         @lang('site.delete') @lang('site.book')
                      </h5>
