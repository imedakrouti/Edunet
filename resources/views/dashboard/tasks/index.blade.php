...
@section('content')
        ...
        <div class="subheader py-2 py-lg-4" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('site.tasks')</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">@lang('site.list') @lang('site.tasks')</span>
       ...
       {{--  {{$taskss->tasks_count}}
        {{$tasks->teachers_count}} --}}
     {{--    @foreach($tasks as $task)
        <h1>{{$task->title}}</h1>
        <a href="{{ route('dashboard.download.task',$task->task) }}"> Download  </a>
        ...
        <div class="card card-custom card-stretch gutter-b">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title ">
                    ...
                    @lang('site.list') @lang('site.tasks')   </h3>
                    <div class="quick-search quick-search-inline w-auto w-lg-300px mx-auto" id="kt_quick_search_inline">
                        <!--begin::Form-->
                        <form  action="{{ route('dashboard.task.index')}}"method="get" class="quick-search-form">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('dashboard.task.create') }}" class="btn btn-success font-weight-bolder font-size-sm">
                            <span class="svg-icon svg-icon-md svg-icon-white">
                                ...
                                <!--end::Svg Icon-->
                            </span>@lang('site.add') @lang('site.task')</a>
                </div>
                @endpermission
            </div>
                            ...
                            <div class="card-title">
                                <div class="d-flex align-items-center">
                                  ...
                                  {{--   <div class="d-flex flex-column flex-grow-1">
                                        <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{ $task->teacher->user->name }}</a>
                                        <span class="text-muted font-weight-bold">{{ $task->created_at->format('Y/m/d') }}</span>
                                    </div> --}}
                                    <div class="d-flex flex-column flex-grow-1">
...
{{--                                         <div class="bgi-no-repeat bgi-size-cover bg-white border-blue-500  d-flex justify-content-center align-items-center rounded min-h-265px" style="background-image: url({{ $task->path_image }})"></div>
 ...
 --}}                                            </div>
                                  ...
                                  <div class="bg-white border-blue-500  d-flex justify-content-center align-items-center">
                                    <video width="320" height="265" controls>
                                        <source src="{{URL::asset("/uploads/tasks/$task->task")}}" type="video/wmv">
