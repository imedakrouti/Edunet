            ...
            <table class="table mb-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ $student->user->path_image }}" alt="User Avatar" width="50px"heght="50px" class="mr-3 rounded-circle "></td>
                        ...
                        <td class="">
                          ...
                          <span class="switch switch-outline switch-icon switch-success">
                            ...
                            <label>
                             <input type="checkbox"  class="toggle-class"data-id="{{$student->user_id}}" {{$student->user->status ? 'checked' : ''}}/>
                             <span></span>
                            </label>
                          </span>
                           <a href="{{ route('dashboard.student.edit', $student->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                            ...
                            <button type="submit" class="btn btn-icon btn-light btn-hover-primary btn-sm " data-toggle="modal" data-target="#Delete_Student{{ $student->id }}" title="Supprimer Etudiant">
                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
